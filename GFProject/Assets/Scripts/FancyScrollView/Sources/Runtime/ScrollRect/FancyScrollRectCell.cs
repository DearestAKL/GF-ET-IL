...
{
    /// <summary>
    /// <see cref="FancyScrollRect{TItemData, TContext}"/> 在其中实现单元的抽象基类.
    /// <see cref="FancyCell{TItemData, TContext}.Context"/> 如果你不需要
    /// 代替 <see cref="FancyScrollRectCell{TItemData}"/> 使用.
    /// </summary>
    /// <typeparam name="TItemData">项目数据类型.</typeparam>
    /// <typeparam name="TContext"><see cref="FancyCell{TItemData, TContext}.Context"/> 类型.</typeparam>
